<template>
  <div class="railway-map-container chart">
    ...
    <!-- <div v-if="currentMapMode === 'heat'" class="legend heat-legend">
      <p class="legend-title">省份数值热力图</p>
    ...
    <div v-if="selectedCity && cityStats.total > 0 && currentMapMode === 'railway'" class="city-stats">
