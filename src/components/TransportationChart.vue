<template>
  <div class="transportation-chart-container">
    <h2>中国主要交通方式数据可视化 (2019-2025)</h2>
    <div ref="chartRef" class="chart-main"></div>
    <div class="annotations">
      <h4>数据说明：</h4>
      <ul>
        <li v-for="(value, key) in chartData.annotations" :key="key">
    ...
    "series": [
      {
        ...
        "type": "bar",
        "data": {
          "高铁": [23.6, 21.7, 24.8, 27.2, 37.6, 40.8, 42.8],
          "航空": [6.6, 4.2, 4.8, 5.5, 6.2, 7.3, 8.1],
          "公路": [83.9, 65.4, 68.2, 70.1, 73.5, 83.9, 85.0]
        }
      },
      {
        "name": "平均时速（km/h）",
      ...
      },
      {
        ...
        "type": "line",
        "data": {
          "高铁": [0.50, 0.50, 0.52, 0.55, 0.58, 0.60, 0.62],
          "航空": [0.87, 0.75, 0.80, 0.85, 0.90, 0.82, 0.78],
          "公路": [0.30, 0.30, 0.32, 0.35, 0.38, 0.40, 0.42]
        }
      }
    ],
    "annotations": {
      "高铁票价": "数据基于二等座客公里收益（如京沪高铁0.50元/km）",
      "航空票价": "含燃油附加费调整影响（2025年春运经济舱均价959元可能指单程总价，这里是元/人公里估算）", // 需要注意单位一致性
      "公路票价": "按500公里行程估算（参考高铁对比数据，单位调整为元/人公里）" // 需要注意单位一致性
    }
  }
});
